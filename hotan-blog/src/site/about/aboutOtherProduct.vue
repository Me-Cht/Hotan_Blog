    ...
    <el-dialog title="文章信息" :visible.sync="dialogFormVisible" width="80%" >
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="文章内容">
          <ProComponent ref="md" v-model="blog.content" :ishljs="true" @imgAdd="imgAdd"/>
        </el-form-item>
    ...
    <el-dialog title="编辑文章" :visible.sync="editBlogFromVisible" width="80%">
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="编辑内容">
          <ProComponent ref="md" v-model="editingBlog.content" :ishljs="true" @imgAdd="imgAdd"/>
        </el-form-item>
...
import ProComponent from '../../../src/components/src/components/pro';
